...
namespace EBankingProject.Controllers
{
    ...
    {
        OnlineEbankingEntities db = new OnlineEbankingEntities();
        // GET: User
        [Authorize]
        ...
        //public ActionResult BalEnquiry()
        //{
        //    Account acc = new Account();
        //    var AccNo = acc.AccountNO;

        //    var Bal = acc.Balance;
        //    return View(AccNo);
        //}
        //[HttpPost]
        //public ActionResult BalEnquiry(BalanceEnquiry bal)
        //{
        //    db.BalanceEnquiries.Add(bal);
        //    db.SaveChanges();
        //    ModelState.Clear();
        //    return View();
        //}
        ...
        [HttpPost]
        public ActionResult FundsTransfer(Account Acc, DateTime transfDate,int transfAmount,int SenderAmount,int RecieverAmount)
