...
namespace EBankingProject.Models
{
    ...
    public partial class OnlineEbankingEntities : DbContext
    {
        public OnlineEbankingEntities()
            : base("name=OnlineEbankingEntities")
        {
        }
        ...
        public virtual DbSet<vwAccTran> vwAccTrans { get; set; }
    }
}
